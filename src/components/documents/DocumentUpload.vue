...
<template>
    <div class="document-upload">
        ...
        <FileUpload mode="basic" :accept="acceptedFileTypes" :maxFileSize="MAX_FILE_SIZE"
            :disabled="disabled || uploading" :chooseLabel="chooseLabel" :auto="true" @select="onFileSelect"
            class="w-full">
            <template #empty>
