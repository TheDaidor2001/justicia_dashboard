<template>
  <div class="activity-section">
    <div class="mb-6">
      ...
      <p class="text-gray-600 dark:text-gray-400">Últimas 10 acciones realizadas en el sistema</p>
    </div>
    ...
    <div v-else-if="!loading" class="text-center py-8">
      ...
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Sin actividad reciente</h3>
      <p class="text-gray-600 dark:text-gray-400">No hay actividad registrada en tu cuenta</p>
    </div>
