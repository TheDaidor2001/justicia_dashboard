      ...
      <p class="text-gray-600 mt-2">
        {{
          isEditMode
            ...
            : 'Completa el formulario para crear un nuevo expediente judicial'
        }}
      </p>
    </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Descripción detallada del caso (opcional)"
              :disabled="loading || submitting"
            />
            <small v-if="v$.description.$error" class="p-error">
              {{ getErrorMessage('description') }}
            </small>
            <small class="text-gray-500"> {{ formData.description.length }}/1000 caracteres </small>
          </div>
          ...
          <div v-if="!isEditMode">
            ...
            <Select
              ...
              class="w-full"
              :class="{ 'p-invalid': v$.departmentId.$error }"
              :disabled="loading || submitting"
            />
          ...
          <div class="flex justify-end gap-2 pt-4 border-t">
            ...
            <Button
              type="submit"
              :label="isEditMode ? 'Guardar Cambios' : 'Crear Expediente'"
