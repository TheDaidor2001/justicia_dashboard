...
const isFormValid = computed<boolean>(() => {
  return email.value.trim() !== '' && password.value !== '' && !errors.email && !errors.password
})
  ...
  <div class="min-h-screen flex bg-gradient-to-br from-gray-50 via-white to-gray-100">
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <InputText
                ...
                v-model="email"
                type="email"
                placeholder="ejemplo@palaciojusticia.gov"
            ...
            <Button
              ...
              :class="{
                '!bg-gray-400 !border-gray-400 cursor-not-allowed': isLoading || !isFormValid,
              }"
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
              ...
              <div class="text-gray-700 space-y-1">
                <div>
                  ...
                  <code class="bg-blue-100 px-1 rounded text-gray-800"
                    >usuario@poderjudicial.gq</code
                  >
                  |
                  <code class="bg-blue-100 px-1 rounded text-gray-800">contraseña</code>
                </div>
                <div class="text-xs text-gray-600 mt-2">
                  * Usar credenciales reales del sistema judicial
                </div>
              </div>
            </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-20">
        ...
        <div
          class="absolute top-40 left-20 w-24 h-24 border-2 border-secondary/70 rounded-full"
        ></div>
        <div
          class="absolute bottom-32 right-20 w-20 h-20 border-2 border-secondary/50 rounded-full"
        ></div>
